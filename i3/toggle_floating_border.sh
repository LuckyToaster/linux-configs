...
elif [[ "$app_instance" == "brave-browser"  || "$app_instance" == "steamwebhelper" ]]; then
    i3-msg 'floating enable; border normal; resize set 1200 800; move position center'
elif [[ "$app_instance" == "kitty" ]]; then
    i3-msg 'floating enable; border normal; resize set 1000 600; move position center'
else
